...
module.exports = merge(base, {
  ...
  module: {
    rules: [
      { // 圖片資源
        ...
        options: {
          publicPath: `${customConfig.Debug.sourcePublicPath}imgs/`,
          name: '[name].[ext]?[hash]',
          outputPath: 'imgs/'
        }
      },
      { // 字體資源
        ...
        options: {
          publicPath: `${customConfig.Debug.sourcePublicPath}fonts/`,
          name: '[name].[ext]?[hash]',
          outputPath: 'fonts/'
        }
      },
  ...
  plugins: [
    new webpack.DefinePlugin({
      'process.env': {
        NODE_ENV: customConfig.Debug.nodeEnv
      },
      'ROOT_FOLDER': customConfig.Debug.rootFolder,
      'API_URL': customConfig.Debug.apiUrl
    }),
